...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ayushgarg/catkin_ws/install_isolated/${idir}'.  Ask the maintainer 'ayushgarg <ayushgarg@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ayushgarg/catkin_ws/install_isolated/lib;/home/ayushgarg/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
