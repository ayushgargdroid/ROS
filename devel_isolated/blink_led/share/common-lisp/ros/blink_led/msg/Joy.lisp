...
(cl:defmethod cl:initialize-instance :after ((m <Joy>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Joy)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name blink_led-msg:<Joy> is deprecated: use blink_led-msg:Joy instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Joy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader blink_led-msg:x-val is deprecated.  Use blink_led-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Joy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader blink_led-msg:y-val is deprecated.  Use blink_led-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'rot-val :lambda-list '(m))
(cl:defmethod rot-val ((m <Joy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader blink_led-msg:rot-val is deprecated.  Use blink_led-msg:rot instead.")
  (rot m))

(cl:ensure-generic-function 'throttle-val :lambda-list '(m))
(cl:defmethod throttle-val ((m <Joy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader blink_led-msg:throttle-val is deprecated.  Use blink_led-msg:throttle instead.")
  (throttle m))
